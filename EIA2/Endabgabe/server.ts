...
export namespace endabgabe {
    ...
    async function retrieveOrders(): Promise<string[] | string> {
        ...
        let answer: Promise<string[]> = await cursor.toArray(); // Jeder Eintrag soll in einem Array gespeichert werden
